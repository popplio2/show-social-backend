...
#     user = models.ForeignKey('UserProfile', on_delete=models.CASCADE)
#     show = models.ForeignKey('Show', on_delete=models.SET_NULL)
...
#         UserProfile, on_delete=models.SET_NULL, related_name='user_posts')
#     title = models.TextField(blank=False)
#     show = models.ForeignKey(
#         'Show', on_delete=models.SET_NULL, related_name='show_posts')
